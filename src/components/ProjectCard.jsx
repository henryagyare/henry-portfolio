      ...
      <div>
        ...
        {p.href ? (
          <a
            ...
            className="mt-4 block font-display font-bold text-xl text-white group-hover:text-indigo-300 transition-colors hover:underline decoration-indigo-400/50 underline-offset-2"
          >
            {p.title}
          </a>
        ) : (
